...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/masterslider.css" /><!-- Master slider css -->
        <link rel="stylesheet" href="css/style.css" /><!-- Master slider default skin -->
        <link rel="stylesheet" href="css/animate.css"/><!-- animations -->
        <link rel='stylesheet' href='css/owl.carousel.css'/><!-- Client carousel -->
        ...
        <!-- Font icons -->
        <link rel="stylesheet" href="css/font-awesome.min.css"/><!-- Fontawesome icons css -->
        
        <link rel="stylesheet" href="css/styleSwitcher.css"/><!-- styleswitcher -->
    </head>
    ...
    <body>
            ...
            <section id="styles-container">
                <section>
                    ...
                    <ul class="header-list clearfix">
                        <li class="active">
                            ...
                            <img src="images/header01.jpg" alt="header 01"/>
                        </li>
                        
                        <li>
                            <a href="header-default-top-bar.html">style 02</a>
                            <img src="images/header02.jpg" alt="header 01"/>
                        </li>
                        
                        <li>
                            <a href="index08.html">style 03</a>
                            <img src="images/header03.jpg" alt="header 01"/>
                        </li>
                        
                        <li>
                            <a href="header-simple-dark-bar.html">style 04</a>
                            <img src="images/header04.jpg" alt="header 01"/>
                        </li>
                        
                        <li>
                            <a href="header-simple-dark.html">style 05</a>
                            <img src="images/header05.jpg" alt="header 01"/>
                        </li>
                        
                        <li>
                            <a href="header-menu-bottom.html">style 06</a>
                            <img src="images/header06.jpg" alt="header 01"/>
                        </li>
                        
                        <li>
                            <a href="header-menu-bottom-dark.html">style 07</a>
                            <img src="images/header07.jpg" alt="header 01"/>
                        </li>
                    </ul><!-- .header-list end -->
                </section>
                ...
                <section>
                    ...
                    <ul class="header-list clearfix">
                        <li class="active">
                            <a href="index.html">style 01</a>                            
                            <img src="images/layout01.jpg" alt="header 01"/>
                        </li>
                        
                        <li>
                            <a href="index02.html">style 02</a>
                            <img src="images/layout02.jpg" alt="header 01"/>
                        </li>
                        
                        <li>
                            <a href="index03.html">style 03</a>
                            <img src="images/layout03.jpg" alt="header 01"/>
                        </li>
                        
                        <li>
                            <a href="index04.html">style 04</a>
                            <img src="images/layout04.jpg" alt="header 01"/>
                        </li>
                        
                        <li>
                            <a href="index05.html">style 05</a>
                            <img src="images/layout05.jpg" alt="header 01"/>
                        </li>
                        
                        <li>
                            <a href="index06.html">style 06</a>
                            <img src="images/layout06.jpg" alt="header 01"/>
                        </li>
                        
                        <li>
                            <a href="index07.html">style 07</a>
                            <img src="images/layout07.jpg" alt="header 01"/>
                        </li>
                        
                        <li>
                            <a href="index08.html">style 08</a>
                            <img src="images/layout08.jpg" alt="header 01"/>
                        </li>
                        
                        <li>
                            <a href="index09.html">style 09</a>
                            <img src="images/layout09.jpg" alt="header 01"/>
                        </li>
                        
                        <li>
                            <a href="index10.html">style 10</a>
                            <img src="images/layout10.jpg" alt="header 01"/>
                        </li>
                    </ul><!-- .header-list end -->
                </section>
                            ...
                            <div class="col-md-12">
                                <nav class="navbar navbar-default nav-left" role="navigation">
                                    ...
                                    <div class="navbar-header">
                                        <div class="logo">
                                            <a href="index.html">
                                                <img src="images/logo.png" alt="Trucking Transportation and Logistics HTML Template"/>
                                            </a>
                                        </div><!-- .logo end -->
        ...
        <div id="masterslider" class="master-slider ms-skin-default mb-0">
            ...
            <div class="ms-slide">
                <!-- slide background -->
                <img src=" " data-src="images/slide01.jpg" alt="Strongest distribution network"/>  

                <img class="ms-layer" src=" " data-src="images/slider-line.jpg" alt=""
            ...
            <div class="ms-slide">
                <!-- slide background -->
                <img src="" data-src="images/slide02.jpg" alt="International Air freight"/> 
                ...
                <img class="ms-layer" src="masterslider/blank.gif" data-src="images/slider-line.jpg" alt=""
            ...
            <div class="ms-slide">
                <!-- slide background -->
                <img src="masterslider/blank.gif" data-src="images/slide03.jpg" alt="Worldwide freight services"/> 
            ...
            <div class="ms-slide">
                <!-- slide background -->
                <img src="masterslider/blank.gif" data-src="images/slide04.jpg" alt="Worldwide freight services"/> 
            ...
            <div class="container">
                <div class="row services-negative-top">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="service-feature-box">
                            <div class="service-media">
                                <img src="images/img02.jpg" alt="Trucking"/>
            ...
            <div class="container">
                ...
                <div class="row mb-30">
                    <div class="col-md-6 col-sm-6">
                        <div class="service-icon-left-boxed">
                            <div class="icon-container animated triggerAnimation" data-animate="zoomIn">
                                <img src="images/contract.jpg" alt="checklist icon"/>
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="service-icon-left-boxed">
                            <div class="icon-container animated triggerAnimation" data-animate="zoomIn">
                                <img src="images/prueba.jpg" alt="globe icon"/>
                            </div><!-- .icon-container end -->
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="service-icon-left-boxed">
                            <div class="icon-container animated triggerAnimation" data-animate="zoomIn">
                                <img src="images/wareh.jpg" alt="forktruck icon"/>
                            </div><!-- .icon-container end -->
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="service-icon-left-boxed">
                            <div class="icon-container animated triggerAnimation" data-animate="zoomIn">
                                <img src="images/consulting.jpg" alt="touch icon"/>
                            </div><!-- .icon-container end -->
                        ...
                        <ul class="service-list clearfix">
                            <li>
                                <div class="icon-container">
                                    <img class="svg-white" src="images/cpg.jpg" alt="icon"/>                                    
                                </div><!-- .icon-container end -->
                            ...
                            <li>
                                <div class="icon-container">
                                    <img class="svg-white" src="images/cg.jpg" alt="icon"/>                                    
                                </div><!-- .icon-container end -->
                            ...
                            <li>
                                <div class="icon-container">
                                    <img class="svg-white" src="images/fab.jpg" alt="icon"/>                                    
                                </div><!-- .icon-container end -->
                            ...
                            <li>
                                <div class="icon-container">
                                    <img class="svg-white" src="images/rg.jpg" alt="icon"/>                                    
                                </div><!-- .icon-container end -->
                            ...
                            <li>
                                <div class="icon-container">
                                    <img class="svg-white" src="images/eog.jpg" alt="icon"/>                                    
                                </div><!-- .icon-container end -->
            ...
            <div class="container">
                <div class="row">
                        ...
                        <ul class="pi-latest-posts clearfix">
                            <li>
                                <div class="post-media">
                                    <img src="images/latest01.jpg" alt=""/>
                                </div><!-- .post-media end -->
                            ...
                            <li>
                                <div class="post-media">
                                    <img src="images/latest02.jpg" alt=""/>
                                </div><!-- .post-media end -->
                    ...
                    <div class="col-md-4 col-sm-12 clearfix">
                        ...
                        <img src="images/locations.jpg" alt="locations illustration"/>
                    ...
                    <div class="col-md-12">
                        <div class="carousel-container">
                            <div id="client-carousel" class="owl-carousel owl-carousel-navigation">
                                <div class="owl-item"><img src="images/client01.png" alt=""/></div>
                                <div class="owl-item"><img src="images/client02.png" alt=""/></div>
                                <div class="owl-item"><img src="images/client03.png" alt=""/></div>
                                <div class="owl-item"><img src="images/client04.png" alt=""/></div>
                                <div class="owl-item"><img src="images/client05.png" alt=""/></div>
                                <div class="owl-item"><img src="images/client06.png" alt=""/></div>
        ...
        <script src="js/owl.carousel.min.js"></script><!-- Carousels script -->
        <script src="js/masterslider.min.js"></script><!-- Master slider main js -->
        <script src="js/jquery.matchHeight-min.js"></script><!-- for columns with background image -->
        <script src="js/jquery.dlmenu.min.js"></script><!-- for responsive menu -->
        <script src="js/styleSwitcher.js"></script><!-- styleswitcher script -->
